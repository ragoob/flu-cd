...
import (
	...
	flucdshv1alpha1 "github.com/ragoob/flu-cd/pkg/apis/flucd.sh/v1alpha1"
	versioned "github.com/ragoob/flu-cd/pkg/client/clientset/versioned"
	internalinterfaces "github.com/ragoob/flu-cd/pkg/client/informers/externalversions/internalinterfaces"
	v1alpha1 "github.com/ragoob/flu-cd/pkg/client/listers/flucd.sh/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.FlucdV1alpha1().Projects(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.FlucdV1alpha1().Projects(namespace).Watch(context.TODO(), options)
			},
		},
		&flucdshv1alpha1.Project{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *projectInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&flucdshv1alpha1.Project{}, f.defaultInformer)
}
