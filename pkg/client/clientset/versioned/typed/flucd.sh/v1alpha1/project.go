...
import (
	...
	scheme "github.com/ragoob/flu-cd/pkg/client/clientset/versioned/scheme"
...
type ProjectInterface interface {
	...
	Apply(ctx context.Context, project *flucdshv1alpha1.ProjectApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.Project, err error)
	ApplyStatus(ctx context.Context, project *flucdshv1alpha1.ProjectApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.Project, err error)
	ProjectExpansion
}
...
func newProjects(c *FlucdV1alpha1Client, namespace string) *projects {
	return &projects{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *projects) Apply(ctx context.Context, project *flucdshv1alpha1.ProjectApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.Project, err error) {
	if project == nil {
...
func (c *projects) ApplyStatus(ctx context.Context, project *flucdshv1alpha1.ProjectApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.Project, err error) {
	if project == nil {
		return nil, fmt.Errorf("project provided to Apply must not be nil")
	}
	patchOpts := opts.ToPatchOptions()
